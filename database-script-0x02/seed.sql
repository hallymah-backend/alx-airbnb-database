...
INSERT INTO Property (
  ...
  ((SELECT user_id FROM users WHERE first_name = 'Halimat'), 'Cozy Lagos Apartment', '1BR apartment near the beach', 'Lagos', 45.00),
  ((SELECT user_id FROM users WHERE first_name = 'John'), 'Downtown Loft', 'Spacious loft in downtown with fast Wi-Fi', 'Abuja', 80.00),
  ((SELECT user_id FROM users WHERE first_name = 'Maria'), 'Family House with Garden', '3BR house perfect for families', 'Lagos', 120.00),
